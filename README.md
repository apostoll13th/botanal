...
**Важно:** Только Python Bot создает таблицы и делает миграции.

Go Backend только читает данные. Подробности в [DATABASE_ARCHITECTURE.md](DATABASE_ARCHITECTURE.md).
