...
- **REST API**: Go 1.23 + Gin 1.11.0 framework
- **Database**: PostgreSQL 15

### Frontend Web
- **React** 19.2 + Hooks & Actions
- **Tailwind CSS** 4.1 для стилей
- **Chart.js** 4.4.7 для графиков
- **Axios** 1.13.2 для API запросов
- **Nginx** для production

### Frontend Mobile
- **Android**: Kotlin 2.2.21 + Jetpack Compose (BOM 2025.10.01)
- **Material Design 3** с градиентами и анимациями
- **Retrofit 3.0** + OkHttp 4.12 для API
- **Coil 3.3** для загрузки изображений
...
- 📝 Мемосы - личный дневник
- 🎁 Список желаний семьи
- 🌓 Темная/светлая тема
- 📱 Установка как PWA приложение

### Через Android приложение
- 💰 Dashboard с балансом и последними операциями
- 📊 Полное управление расходами и доходами
- 💼 Управление бюджетами с визуальными прогресс-барами
- 📝 Мемосы - личный дневник с поиском
- 🎁 Wishlist семьи с приоритетами и картинками
- 🎨 Material Design 3 с красивыми градиентами
- ⚡ Быстрая загрузка через ViewModels + StateFlow
- 🔄 Реал-тайм синхронизация с Go backend
